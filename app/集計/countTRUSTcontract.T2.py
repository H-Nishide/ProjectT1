...
#                販社別＋製品別件数集計
#   2024.1119 T2 sqlalchemy利用でMySQL接続　
...
# てすと select_all_data_query = "SELECT * FROM authtrustuser.back_user;"
# てすと df = pd.read_sql(select_all_data_query, con=engine)
##############################################################################################
